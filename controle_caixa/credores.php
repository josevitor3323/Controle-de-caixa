...
.tab{width: 500px; margin-left: 40px; background-color: white; padding: 14px;}
    </style>
</head>
            ...
            <div class="container-fluid px-4">
                <div class="row g-4 my-2">
                    <div class="col-md-3">
                        <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                            <div>
                                ...
                                <p class="fs-5">Número de credores</p>
                            </div>
                    ...
                    <div class="col-md-3">
                        <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                            <div>
                                <h3 class="fs-2"><?php echo number_format($total_cred['total'], 2, ',', '.'); ?></h3>
